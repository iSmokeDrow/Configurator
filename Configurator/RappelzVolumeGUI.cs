...
namespace Configurator
{
    ...
    {
        List<ClientSetting> settings = null;

        public RappelzVolumeGUI(List<ClientSetting> inSettings)
        {
            InitializeComponent();
        ...
        {
            List<ClientSetting> soundSettings = settings.FindAll(s => s.Name.StartsWith("SOUND_"));
            foreach (ClientSetting setting in soundSettings)
            {
